...
//ad入れ替え
function reflashAd() {
	var spad0 = document.getElementById("spad0");
	var spad1 = document.getElementById("spad1");
	var spad2 = document.getElementById("spad2");
	
	var r = getRandomInt(2);

	if(r==0) {
		spad0.style.display = "block";
		spad1.style.display = "none";
		spad2.style.display = "none";
	} else if(r==1) {
		spad0.style.display = "none"
		spad1.style.display = "block";;
		spad2.style.display = "none";
	} else {
		spad0.style.display = "none"
		spad1.style.display = "none";
		spad2.style.display = "block";
	}
	/*
	var addom = document.getElementById("spad");
	$(addom).empty();
	//$(addom).append("<script src=\"https://adm.shinobi.jp/s/b67e935ca7dc87e2653ae36b7377d750\"></script>");
	addom.appendChild(".<script src=\"https://adm.shinobi.jp/s/b67e935ca7dc87e2653ae36b7377d750\"></script>");
	*/

	//document.getElementById('ad').contentDocument.location.reload(true);
}