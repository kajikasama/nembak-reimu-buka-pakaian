(function (cjs, an) {
  ...
  (lib.clothe = function () {
    this.initialize(img.clothes);
  }).prototype = p = new cjs.Bitmap();
  p.nominalBounds = new cjs.Rectangle(0, 0, 480, 800);

  (lib.underclothes = function () {
    this.initialize(img.underclothes);
  }).prototype = p = new cjs.Bitmap();
  p.nominalBounds = new cjs.Rectangle(0, 0, 480, 800);

  (lib.sweat = function () {
    this.initialize(img.sweat);
  }).prototype = p = new cjs.Bitmap();
  p.nominalBounds = new cjs.Rectangle(0, 0, 480, 800);
  ...
  (lib.reimu0 = function () {
    this.initialize(img.reimu0);
  }).prototype = p = new cjs.Bitmap();
  p.nominalBounds = new cjs.Rectangle(0, 0, 480, 800);

  (lib.reimu1 = function () {
    this.initialize(img.reimu1);
  }).prototype = p = new cjs.Bitmap();
  p.nominalBounds = new cjs.Rectangle(0, 0, 480, 800);

  (lib.reimu2 = function () {
    this.initialize(img.reimu2);
  }).prototype = p = new cjs.Bitmap();
  p.nominalBounds = new cjs.Rectangle(0, 0, 480, 800);

  (lib.reimu3 = function () {
    this.initialize(img.reimu3);
  }).prototype = p = new cjs.Bitmap();
  p.nominalBounds = new cjs.Rectangle(0, 0, 480, 800);

  (lib.reimu4 = function () {
    this.initialize(img.reimu4);
  }).prototype = p = new cjs.Bitmap();
  p.nominalBounds = new cjs.Rectangle(0, 0, 480, 800);

  (lib.reimu5 = function () {
    this.initialize(img.reimu5);
  }).prototype = p = new cjs.Bitmap();
  p.nominalBounds = new cjs.Rectangle(0, 0, 480, 800);

  (lib.reimuclimax = function () {
    this.initialize(img.reimuclimax);
  }).prototype = p = new cjs.Bitmap();
  ...
  (lib.window = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s("#000000")
      .ss(3, 1, 1)
      .p("Eggzgp5MBBnAAAMAAABTzMhBnAAAg");
  ...
  (lib.sound_on = function (mode, startPosition, loop) {
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        ""
      );
    ...
    this.shape_3.graphics
      ...
      .ss(3, 1, 1)
      .p(
        ""
      );
  ...
  (lib.HitMc17 = function (mode, startPosition, loop) {
    ...
    lib.HitMc17,
    new cjs.Rectangle(0, 0, 36.5, 46.5),
    null
  );
  ...
  (lib.HitMc13 = function (mode, startPosition, loop) {
    ...
    lib.HitMc13,
    new cjs.Rectangle(0, 0, 38.5, 48.5),
    null
  );
  ...
  (lib.HitMc11 = function (mode, startPosition, loop) {
    ...
    lib.HitMc11,
    new cjs.Rectangle(0, 0, 87.5, 82.5),
    null
  );
  ...
  (lib.HitMc6 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      .f("rgba(0,0,255,0.2)")
      .s()
      .p("AjRTJMAAAgmRIGjAAMAAAAmRg");
    this.shape.setTransform(21, 122.5);

    this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));
  }).prototype = getMCSymbolPrototype(
    lib.HitMc6,
    new cjs.Rectangle(0, 0, 42, 245),
    null
  );
  ...
  (lib.HitMc1 = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      .f("rgba(255,0,0,0.2)")
      .s()
      .p("AqiQ4MAAAghvIVFAAMAAAAhvg");
    this.shape.setTransform(67.5, 108);

    this.timeline.addTween(cjs.Tween.get(this.shape).wait(1));
  }).prototype = getMCSymbolPrototype(
    lib.HitMc1,
    new cjs.Rectangle(0, 0, 135, 216),
    null
  );
  ...
  (lib.gra9d = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AhjCPQgRgQgOggIBQgSQAEALAGAHQAOAOAXAAQAiAAAQgcQALgRADglQgeAdgwAAQg2AAghgeQgggeAAgyQAAg1AlghQAlghA7AAQBNAAAlA7QAaAoAABEQAABAgXAvQgWAuguAPQgaAIgaAAQg5AAgkgfgAgqhfQgQAPgBAWQAAAXAQAPQAOAOAZAAQAZAAAQgPQAQgOAAgXQAAgXgPgOQgQgOgYAAQgZAAgPAOg"
      );
    ...
    this.shape_1.graphics
      ...
      .ss(3, 1, 1)
      .p(
        "AiCBfQANAgASAQQAjAfA5AAQAbAAAagIQAugPAWguQAXgvAAhAQAAhEgZgoQglg7hNAAQg8AAglAhQglAhAAA1QAAAyAgAeQAhAeA2AAQAwAAAegdQgDAlgKARQgRAcghAAQgZAAgNgOQgGgHgEgLgAgEgGQgYAAgPgOQgPgPAAgXQAAgWAPgPQAQgOAZAAQAYAAAQAOQAPAOAAAXQAAAXgQAOQgQAPgZAAg"
      );
  ...
  (lib.gra8d = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        ""
      );
    ...
    this.shape_1.graphics
      ...
      .ss(3, 1, 1)
      .p(
        ""
      );
  ...
  (lib.gra7d = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AhHCoQAQhZAhhDQAWgvAqg7IhxAAQgkAAgYADIAAhMQAXADAqAAICGAAQAqAAAWgCIAABDQgfAigXAuQgZAtgMApQgMAqgIA7g"
      );
    ...
    this.shape_1.graphics
      ...
      .ss(3, 1, 1)
      .p(
        "ACEimQgWACgqAAIiGAAQgrAAgWgDIAABMQAYgDAkAAIBxAAQgqA7gWAvQggBDgRBZIBcAAQAIg7AMgqQANgpAYgtQAXguAfgig"
      );
  ...
  (lib.gra6d = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AhfCGQgpgtAAhUQAAhPAhguQAng1BJAAQA9AAAhAjQAPAQALAdIhOARQgKgigjAAQgkAAgRAjQgIASgDAfQAMgMANgGQAWgKAeAAQA2AAAgAeQAgAdAAA0QAAA0glAhQglAgg7AAQhAAAgjgogAgkAWQgPAOAAAXQgBAWARAPQAPAOAXAAQAZAAAQgPQAQgOAAgXQAAgXgOgNQgPgNgbAAQgYAAgQANg"
      );
    this.shape.setTransform(13.7, 17.4);
    ...
    this.shape_1.graphics
      ...
      .ss(3, 1, 1)
      .p(
        "ACChdQgMgdgPgQQghgjg9AAQhJAAgnA1QghAuAABPQAABUApAtQAkAoA/AAQA7AAAlggQAlghAAg0QAAg0gfgdQgggeg3AAQgeAAgWAKQgNAGgMAMQADgfAIgSQARgjAkAAQAjAAAKAigAAFAJQAaAAAPANQAOANAAAXQAAAXgQAOQgQAPgZAAQgXAAgPgOQgRgPAAgWQAAgXAQgOQAQgNAZAAg"
      );
    this.shape_1.setTransform(13.7, 17.4);
  ...
  (lib.gra5d = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AhxB7QgLgQgKgdIBRgMQAKAmArAAQAYAAAPgOQAQgPgBgYQAAgYgPgOQgOgNgZAAQglAAgNAcIhLgHIARi+ICfABQArAAAXgDIAABGQgegDgjAAIhdAAIgEA9QAagTAlAAQA2AAAgAhQAeAdABAyQAAA5gkAhQglAgg+AAQhNAAgkgxg"
      );
    ...
    this.shape_1.graphics
      ...
      .ss(3, 1, 1)
      .p(
        "AgohoIBcAAQAjAAAeADIAAhGQgXADgrAAIifgBIgQC+IBKAHQANgcAlAAQAZAAAOANQAPAOAAAYQAAAYgPAPQgPAOgYAAQgrAAgKgmIhRAMQAKAdALAQQAjAxBOAAQA/AAAkggQAkghAAg5QAAgygfgdQggghg2AAQglAAgaATg"
      );
  ...
  (lib.gra4d = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AAQCmQADgVAAgdIAAgTIhwAAQghAAgTABIAAhHIB9iRQAWgaAOgWIBSAAQgDAgAAAjIAACBIALAAQASAAAWgDIAABJQgSgDgVAAIgMAAIAAAVQAAAcADAUgAg8AfIBPAAIAAgtQAAggADgag"
      );
    ...
    this.shape_1.graphics
      ...
      .ss(3, 1, 1)
      .p(
        "AiRBjQATgCAhAAIBwAAIAAAUQAAAcgDAWIBSAAQgDgVAAgcIAAgVIAMAAQAVAAASADIAAhJQgWADgSAAIgLAAIAAiBQAAgjADggIhSAAQgOAVgWAbIh9CRgAATAfIhPAAIBShnQgDAaAAAgg"
      );
  ...
  (lib.gra3d = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AhaCYQgcgSgNghIgHgWIBVgOQADARAIAIQARASAcAAQAXAAAOgLQAOgLAAgTQAAgagWgIQgPgFgVAAQgaAAgXACIAAhEQAUADAWAAQA4AAAAgnQAAghgqAAQgnAAgIAkIhXgMQAKggARgTQAlgoBIAAQBDAAAjAiQAXAXAAAiQAAA/hFAQQAgAEAUARQAaAYAAAjQAAAggQAVQgOATgYALQghAQgyAAQg6AAgigXg"
      );
    ...
    this.shape_1.graphics
      ...
      .ss(3, 1, 1)
      .p(
        "AiKBPIAHAWQANAhAcASQAiAXA6AAQAyAAAhgQQAYgLAOgTQAQgVAAggQAAgjgagYQgUgRgggEQBFgQAAg/QAAgigXgXQgjgihDAAQhIAAglAoQgRATgKAgIBXAMQAIgkAnAAQAqAAAAAhQAAAng4AAQgWAAgUgDIAABEQAXgCAaAAQAVAAAPAFQAWAIAAAaQAAATgOALQgOALgXAAQgcAAgRgSQgIgIgDgRg"
      );
  ...
  (lib.gra2d = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "ABCCpIiMAAQgoAAgTABQACgbAGgUQAQgzAqgnQAUgTAyghQAZgRAJgKQAJgLAAgOQAAgOgMgJQgMgJgTAAQgcAAgNAUQgHAMgDAWIhUgJQAIguAVgZQAjgpBGAAQBUAAAfAyQAOAVAAAaQAAAsglAdQgNAMgtAfQgtAggNAYIBcAAQArAAAVgDIAABLQgggCgkAAg"
      );
    ...
    this.shape_1.graphics
      ...
      .ss(3, 1, 1)
      .p(
        "ABCCpQAkAAAgACIAAhLQgVADgrAAIhcAAQANgYAtggQAtgfANgMQAlgdAAgsQAAgagOgVQgfgyhUAAQhGAAgjApQgVAZgIAuIBUAJQADgWAHgMQANgUAcAAQATAAAMAJQAMAJAAAOQAAAOgJALQgJAKgZARQgyAhgUATQgqAngQAzQgGAUgCAbQATgBAoAAg"
      );
  ...
  (lib.gra1d = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AgMCoQAEgYAAglIAAjLIgRAAQgYAAgYADIAAhKQAQADAgAAIAxAAQAiAAAQgBQgDAeAAAiIAADQQAAAjADAag"
      );
    ...
    this.shape_1.graphics
      ...
      .ss(3, 1, 1)
      .p(
        "AhJhdQAYgDAYAAIARAAIAADMQAAAjgEAZIBWAAQgDgaAAgiIAAjRQAAgjADgeQgQACgiAAIgxAAQggAAgQgDg"
      );
  ...
  (lib.gra0d = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AhgCIQgUgTgJgZQgQgqAAgyQAAhEAZgqQAmg/BOAAQA7AAAmAlQAUAVAJAYQAQAqAAAxQAABGgZApQgmA/hPAAQg7AAglgmgAgrhOQgQAcAAAwQAABrA7AAQA7AAAAhqQAAhog7AAQgbAAgQAbg"
      );
    ...
    this.shape_1.graphics
      ...
      .ss(3, 1, 1)
      .p(
        "AAACuQBPAAAmg/QAZgpAAhGQAAgxgQgqQgJgZgUgUQgmglg7AAQhOAAgmA/QgZAqAABEQAAAxAQArQAJAYAUAVQAlAlA7AAgAAAhpQA7AAAABoQAABqg7AAQg7AAAAhrQAAgxAQgbQAQgbAbAAg"
      );
  ...
  (lib.gra_start = function (mode, startPosition, loop) {
    ...
    lib.gra_start,
    new cjs.Rectangle(-5, -5, 405, 97.1),
    null
  );
  ...
  (lib.gra_retry = function (mode, startPosition, loop) {
    ...
    this.shape_1.graphics
      ...
      .ss(3, 1, 1)
      .p(
        ""
      );
  ...
  (lib.gra_pushtostart = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        ""
      );
    ...
    lib.gra_pushtostart,
    new cjs.Rectangle(-1, -1, 237.7, 24.8),
    null
  );
  ...
  (lib.gra_moji_sec = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        ""
      );
    ...
    this.shape_1.graphics
      ...
      .ss(3, 1, 1)
      .p(
        ""
      );
  ...
  (lib.gra_moji_record = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        ""
      );
    ...
    this.shape_1.graphics
      ...
      .ss(2, 1, 1)
      .p(
        ""
      );
  ...
  (lib.gra_moji_new_record = function (mode, startPosition, loop) {
    ...
    this.shape_1.graphics
      ...
      .ss(3, 1, 1)
      .p(
        ""
      );
  ...
  (lib.gra_moji_critical = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        ""
      );
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        ""
      );
    ...
    this.shape_2.graphics
      ...
      .s()
      .p(
        ""
      );
  ...
  (lib.gra_moji_cleartime = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        ""
      );
  ...
  (lib.gra_moji_clear = function (mode, startPosition, loop) {
    ...
    this.shape_1.graphics
      ...
      .ss(3, 1, 1)
      .p(
        ""
      );
  ...
  (lib.gra_icon_heart = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "Ag/AXQgaghAAgbQAAgOAGgMQAHgMALgHQAMgHAPAAQATAAAKAHQAHAGACAIQAKgVAdAAQAWAAAPAOQAOAQAAAWQAAAfgcAiQgOAQgbAaIgVAUQgsgqgTgZg"
      );
    ...
    this.shape_1.graphics
      ...
      .ss(3, 1, 1)
      .p(
        "AAABaIAVgUQAbgaAOgQQAcgiAAgfQAAgWgOgQQgPgOgWAAQgdAAgKAUQgCgHgHgGQgLgHgSAAQgPAAgMAHQgLAHgHAMQgGAMAAAOQAAAbAaAhQASAZAtAqg"
      );
  ...
  (lib.gra_bullet_empty = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .ss(3, 1, 1)
      .p(
        "AgxjQIAABpIgGAkIAAE7IAAAGIA4AAIAjAAIAUAAIAAgGIAAk7IgGgkIAAhpQgGgMgHgJQgSgXgSgBQgYgBgaAug"
      );
  ...
  (lib.gra_bullet = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AAkD+IAAlBIAUAAIAAE7IAAAGgAg3D+IAAgGIAAk7IA4AAIAAFBgAAkhnIABh+QAHAJAGAMIAABpgAgxhnIAAhpQAaguAYABIAACWg"
      );
    this.shape.setTransform(5.6, 25.4);
    ...
    this.shape_1.graphics
      .f("#553923")
      .s()
      .p("AAkASIgjAAIg4AAIAGgjIAyAAIAjAAIAOAAIAGAjg");
    ...
    this.shape_2.graphics
      .f("#D9BB65")
      .s()
      .p("AgRD+IAAlBIAiAAIAAFBgAgRhoIAAiVQARAAASAYIgBB9g");
  ...
  (lib.gra_bokan = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p("EglfAyyMAAAhljMBK/AAAMAAABljg");
  ...
  (lib.FocusMc = function (mode, startPosition, loop) {
    ...
    // actions tween:
    this.timeline.addTween(
      cjs.Tween.get(this).call(this.frame_0).wait(4).call(this.frame_4).wait(1)
    );
    ...
    this.shape.graphics
      ...
      .ss(3, 1, 1)
      .p(
        "AgCnzQABAAABAAQDPAACSCSQCTCTAADOQAAACAAACQgCDMiRCRQiSCTjPAAQgBAAgBAAQjNgBiSiSQiRiRgBjMQAAgCAAgCQAAjOCSiTQCSiRDNgBg"
      );
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        "AgCH0QjNgBiSiSQiQiQgCjMIAAgFQAAjOCSiSQCSiSDNgBIACAAQDPAACSCTQCTCSAADOIAAAFQgBDMiSCQQiSCTjPAAIgCAAg"
      );
    ...
    this.shape_2.graphics
      ...
      .ss(3, 1, 1)
      .p(
        "AhCnvQAfgEAhAAQABAAABAAQDPAACSCTQCTCSAADOQAAADAAACQgCDMiRCRQgPAPgQAOAgSH0QjDgGiMiMQiRiRgBjMQAAgCAAgDQAAghAEgh"
      );
    ...
    this.shape_3.graphics
      ...
      .s()
      .p(
        "AgBF3QiagBhthtQhZhZgRh2QgEgbAAgcIAAgDQAAiSBjhqIALgNQBthtCaAAIABAAQAeAAAcAEIAGABQBzASBWBWQBuBuAACbIAAADQgBCZhtBtQhtBuicAAIgBAAg"
      );
    ...
    this.shape_4.graphics
      ...
      .s()
      .p(
        "AgiAjQgPgOAAgUIAAgBQAAgUAPgOQAOgPAUAAQAVAAAOAPQAPAOAAAUIAAABQAAAUgPAOQgOAPgVAAQgUAAgOgPg"
      );
    ...
    this.timeline.addTween(
      cjs.Tween.get({})
        ...
        .to({ state: [{ t: this.shape_4 }, { t: this.shape }] }, 1)
        .to({ state: [] }, 1)
        .wait(1)
    );
  ...
  (lib.ending = function (mode, startPosition, loop) {
    ...
    // レイヤー_1
    this.instance = new lib.reimuclimax();
    this.instance.parent = this;
  ...
  (lib.ClothMc2 = function (mode, startPosition, loop) {
    ...
    // レイヤー_1
    this.instance = new lib.underclothes();
    this.instance.parent = this;
  ...
  (lib.StartMc = function (mode, startPosition, loop) {
    ...
    // actions tween:
    this.timeline.addTween(
      cjs.Tween.get(this).wait(80).call(this.frame_80).wait(1)
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_3).to({ _off: true }, 24).wait(57)
    );
    ...
    this.shape.graphics
      .f("rgba(0,0,0,0.298)")
      .s()
      .p("EglfA+gMAAAh8/MBK/AAAMAAAB8/g");
    this.shape.setTransform(240, 400);

    this.timeline.addTween(
      cjs.Tween.get(this.shape).to({ _off: true }, 80).wait(1)
    );
  }).prototype = p = new cjs.MovieClip();
  p.nominalBounds = new cjs.Rectangle(0, 0, 480, 800);
  ...
  (lib.PushStartMc = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance).to({ _off: true }, 23).wait(5)
    );
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.PushRetryMc = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance).to({ _off: true }, 13).wait(4)
    );
  }).prototype = p = new cjs.MovieClip();
  p.nominalBounds = new cjs.Rectangle(-1.5, -1.5, 209.1, 29.7);
  ...
  (lib.NumberMc2 = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get({})
        .to({
          state: [{ t: this.unit1 }, { t: this.unit2 }, { t: this.unit3 }],
        })
        .wait(1)
    );
  }).prototype = getMCSymbolPrototype(
    lib.NumberMc2,
    new cjs.Rectangle(-65.7, -2, 91.4, 37.7),
    null
  );
  ...
  (lib.NumberMc = function (mode, startPosition, loop) {
    ...
    lib.NumberMc,
    new cjs.Rectangle(-64.2, -0.5, 88.4, 34.7),
    null
  );
  ...
  (lib.NewRecordMc = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance).to({ _off: true }, 23).wait(4)
    );
  }).prototype = p = new cjs.MovieClip();
  p.nominalBounds = new cjs.Rectangle(-1.5, -1.5, 123, 17.2);
  ...
  (lib.GameoverMc = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance).wait(16).to({ _off: false }, 0).wait(1)
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.shape).wait(1).to({ _off: false }, 0).wait(16)
    );
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.EffectStarMc = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      .f("#FF0000")
      .s()
      .p("Ah0FuIAAmpIi3AAIErkyIEsEyIi4AAIAAGpg");
    this.shape.setTransform(32.8, 91.7);
    this.shape._off = true;

    this.timeline.addTween(
      cjs.Tween.get(this.shape).wait(1).to({ _off: false }, 0).wait(28)
    );
    ...
    this.shape_1.graphics
      ...
      .s()
      .p("EggnAJJIAAyRMBBPAAAIAASRg");
    this.shape_1.setTransform(210.8, 113.3);
    this.shape_1._off = true;

    this.timeline.addTween(
      cjs.Tween.get(this.shape_1).wait(1).to({ _off: false }, 0).wait(28)
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_2).to({ _off: true }, 1).wait(28)
    );
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.DamageNumberMc = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.n)
        .to({ regX: 8.5, y: -1 }, 5, cjs.Ease.get(1))
        .to({ regX: 8.4, y: 8.7 }, 5, cjs.Ease.get(-1))
        .to({ _off: true }, 7)
        .wait(1)
    );
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.CharaMc = function (mode, startPosition, loop) {
    ...
    // actions tween:
    this.timeline.addTween(
      cjs.Tween.get(this).wait(1).call(this.frame_1).wait(7)
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.cloth_mc1).to({ _off: true }, 7).wait(1)
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.cloth_mc2).to({ _off: true }, 7).wait(1)
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.cloth_mc3).to({ _off: true }, 7).wait(1)
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.cloth_mc4).to({ _off: true }, 7).wait(1)
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.sweat_mc).to({ _off: true }, 7).wait(1)
    );

    // レイヤー_1
    this.instance = new lib.reimu0();
    this.instance.parent = this;

    this.instance_1 = new lib.reimu1();
    this.instance_1.parent = this;

    this.instance_2 = new lib.reimu2();
    this.instance_2.parent = this;

    this.instance_3 = new lib.reimu3();
    this.instance_3.parent = this;

    this.instance_4 = new lib.reimu4();
    this.instance_4.parent = this;

    this.instance_5 = new lib.reimu5();
    this.instance_5.parent = this;
  ...
  (lib.BtnStartMc = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      .f("rgba(255,255,255,0.008)")
      .s()
      .p("EgpFAuQMAAAhcfMBSLAAAMAAABcfg");
    ...
    lib.BtnStartMc,
    new cjs.Rectangle(-25.9, 272, 526, 592),
    null
  );
  ...
  (lib.BomEffectMc = function (mode, startPosition, loop) {
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.shape).to({ _off: true }, 1).wait(5)
    );
  }).prototype = p = new cjs.MovieClip();
  ...
  (lib.RecordMc = function (mode, startPosition, loop) {
    ...
    this.record_time2.setTransform(
      190.3,
      11.8,
      1.359,
      1.354,
    ...
    this.record_time1.setTransform(
      116.3,
      11.8,
      1.359,
      1.354,
    ...
    lib.RecordMc,
    new cjs.Rectangle(-1, -1, 250.2, 26.8),
    null
  );
  ...
  (lib.EndingMc = function (mode, startPosition, loop) {
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        ""
      );
    this.shape.setTransform(853.8, 455);

    this.timeline.addTween(
      cjs.Tween.get(this.shape).to({ _off: true }, 1).wait(49)
    );
        ...
        .to(
          {
            state: [
              { t: this.instance_7 },
              { t: this.instance_6 },
              { t: this.time1, p: { x: 531.5 } },
              { t: this.time2, p: { x: 605.5 } },
              { t: this.instance_5, p: { x: 567.4 } },
              { t: this.record_time1, p: { x: 531.5 } },
              { t: this.record_time2, p: { x: 605.5 } },
              { t: this.instance_4, p: { x: 567.4 } },
              { t: this.instance_3 },
              { t: this.instance_2 },
              { t: this.instance_1 },
              { t: this.instance },
        ...
        .to(
          {
            state: [
              { t: this.instance_7 },
              { t: this.instance_6 },
              { t: this.time1, p: { x: 201.5 } },
              { t: this.time2, p: { x: 275.5 } },
              { t: this.instance_5, p: { x: 237.4 } },
              { t: this.record_time1, p: { x: 201.5 } },
              { t: this.record_time2, p: { x: 275.5 } },
              { t: this.instance_4, p: { x: 237.4 } },
              { t: this.instance_3 },
              { t: this.instance_2 },
              { t: this.instance_1 },
              { t: this.instance },
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.whiteout_mc).wait(1).to({ _off: false }, 0).wait(49)
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_9)
        ...
        .to({ _off: false }, 0)
        .to(
          { regX: 240, regY: 399.8, scaleX: 0.87, scaleY: 0.87, x: 238.1 },
          10,
          cjs.Ease.quintIn
        )
        .to({ regX: 239.9, regY: 399.9, scaleX: 1.02, scaleY: 1.02, x: 238 }, 2)
  ...
  (lib.focusReimu = function (mode, startPosition, loop) {
    ...
    this.btn_sound_mc.setTransform(
      14.5,
      13.1,
      0.595,
      0.594,
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.btn_sound_mc).to({ _off: true }, 2).wait(1)
    );
    ...
    this.btn_tweet_mc.setTransform(
      540,
      266.1,
      1.111,
      1.111,
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.btn_tweet_mc)
        .wait(1)
        .to({ regX: 22.6, scaleX: 1.01, scaleY: 1.01, x: 397.8, y: 258.8 }, 0)
        .wait(2)
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.btn_display_mc).wait(2).to({ x: 240 }, 0).wait(1)
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.ending_mc).wait(2).to({ _off: false }, 0).wait(1)
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.gameover_mc).wait(2).to({ _off: false }, 0).wait(1)
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.start_mc).wait(2).to({ _off: false }, 0).wait(1)
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.btn_start_mc).to({ _off: true }, 2).wait(1)
    );
    ...
    this.shape.graphics
      ...
      .s()
      .p(
        "AgTBTIAAgmIAnAAIAAAmgAgPAgIAAgJIgBgQIgEg+IgCgbIAtAAIgCAbIgEA+IgBAQIABAJg"
      );
    ...
    this.shape_1.graphics
      ...
      .s()
      .p(
        "AguA6QAigCAVgIQATgHAIgOQADgGAAgHQAAgRgZAAQgQAAgZADQgaAEgPAGIgIgkIAagDQAngGAcgBQAnAAANAXQAIAMAAAOQAAASgMARQgLAQgTAKQgYANgrAFQgFgSgJgQgAg1g6IAKghQAjALAuAAIAPgBIgFAiQg4gBgtgKg"
      );
    ...
    this.shape_2.graphics
      ...
      .s()
      .p(
        "Ag5BDQgLgJAAgPQAAgQAMgJQANgKAVABIAKAAIgChEIgBgQIAfABQgCAKAAAXQAdAAATgFIACAcIgOACQgQABgTAAIACAdQAYAIAXAQIAFAEIgTAcQgOgPgTgLQAAAJgCAFQgIASgfAAQgVAAgMgJgAglArQAAAGANABQANAAAAgLIgBgEIgJgBQgQAAAAAJg"
      );
    ...
    this.shape_3.graphics
      ...
      .s()
      .p(
        "Ag7BIQgIgIgEgMQgDgLAAgVIABgsIABgvIgBgPIAnAAQgCAKgBAgIgCA5QAAAYAFAHQAGAKARAAQAPAAALgJQAMgJAFgQQAGgPACgUQATAOAQAGQgLAogPAQQgXAagmAAQgfAAgQgPg"
      );
    ...
    this.shape_4.graphics
      ...
      .s()
      .p(
        ""
      );
    ...
    this.shape_5.graphics
      ...
      .s()
      .p(
        "AhCA9QgPgVgDgtQgCgXgBgjIAAgOIAmAAQgCAOAAAWQAAAhAEAWQAEAWAHAAQADAAADgHQAHgSADgQQALAMAQAMQgGAWgIARQgLAUgTAAQgRAAgMgRgAAMg4IAegOQAmAuAIBFIgjANQgEhDglgvg"
      );
    ...
    this.shape_6.graphics
      ...
      .s()
      .p(
        "AgbAwQgGgagIgdQgTAGgIADIgIgcIAcgIQgGgUgFgKIAfgIIADAOIADAJIACAHIAWgFQAAgVgCgHIAfAAIgBAYIAGAAQATAAALALQALAKAAASQAAAUgQALQgOAKgTAAQgKAAgNgDQgBgQgEgOQAPAFAKAAQAVAAAAgNQAAgMgQAAQgMAAgQAEIgOAEIAEARIAMAyIAFASIgfAHIgFgcg"
      );
    ...
    this.shape_7.graphics
      ...
      .s()
      .p(
        "AgwBTQAAgRgEgRQAeAJAXAAQAUAAAMgGQAMgFAAgKQAAgPgcAAQgWAAgSAJQgJAFgEAGIgigLQAGgIAIgTQAIgTAEgNIgIAAIgTgBIgHAAIgCAAIAAghQANADAeABQAFgVAAgKIAkADIgGAbQA4gCASgGIABAiIgOABQgmAEgfABQgFAQgGANQATgIAXAAQAcAAAQAJQAQAMAAAWQAAAYgVAPQgWAOgkAAQgZAAgZgHg"
      );
    ...
    this.shape_9.graphics
      ...
      .s()
      .p(
        ""
      );
    ...
    this.shape_10.graphics
      ...
      .s()
      .p(
        ""
      );
    ...
    this.shape_11.graphics
      ...
      .s()
      .p(
        "AA0BRQghgCgRgJQgjgQAAgnQAAgYARgUQAGgIAMgJIhEAHIgRACIgCgkIAIAAIAigBQApgEBBgCIAWgCIABAlIgFgBQgYABgWAOQgPAIgIAMQgJAMAAAMQAAAQARAIQAPAIAXAAIAGgBIgEAmg"
      );
    ...
    this.shape_13.graphics
      ...
      .s()
      .p(
        ""
      );
    ...
    this.shape_14.graphics
      ...
      .s()
      .p(
        ""
      );
    ...
    this.shape_15.graphics
      ...
      .s()
      .p(
        ""
      );
    ...
    this.shape_16.graphics
      ...
      .s()
      .p(
        ""
      );
    ...
    this.shape_17.graphics
      ...
      .s()
      .p(
        ""
      );
    ...
    this.shape_18.graphics
      ...
      .s()
      .p(
        ""
      );
    ...
    this.shape_20.graphics
      ...
      .s()
      .p(
        ""
      );
    ...
    this.shape_21.graphics
      ...
      .s()
      .p(
        ""
      );
    ...
    this.shape_22.graphics
      ...
      .s()
      .p(
        ""
      );
    ...
    this.shape_23.graphics
      ...
      .s()
      .p(
        ""
      );
    ...
    this.shape_24.graphics
      ...
      .s()
      .p(
        ""
      );
    ...
    this.shape_25.graphics
      ...
      .s()
      .p(
        "AAFAbQgbAhguAWQgIgSgNgOQAlgOAbgaQAagZANghIgzABQgVAAgKACIgBgkIAUACIALgBIBEgBQALAAAFgCIASASQgEAEgDAIQgPAigPATQASANALAKQALAJAYAWIgcAeQgZggghgZg"
      );
    ...
    this.shape_26.graphics
      ...
      .s()
      .p(
        "AhVA8QAmgUAOgcQAGgNAEgVIgZAAQgQAAgLABIAAgiQALACAQAAIAcAAIABgaIgBgKIAlABIgDAYIAAALIAsAAQAHgBAGgCIAPAOQgCAFAAAKQgDBEgFAUQgFAOgIAGQgJAFgQAAIgagBQgBgTgGgRQAPAEALABQAHgBADgEQACgDACgNQAEgZAAgeIgmAAIgDAUQgHAdgOAVQgQAWgeAUQgLgRgPgNg"
      );
    ...
    this.shape_27.graphics
      .f("#000000")
      .s()
      .p("AAwASIhfAAIgpABIAAglQAMACAdAAIBfAAQAYAAARgCIAAAlIgpgBg");
    ...
    this.shape_28.graphics
      ...
      .s()
      .p(
        "AALBKIABgWIAAgEIAAgtQgEAHgLANQgUAVggARQgIgPgMgLQAZgLAQgOQARgNAJgPIgeAAIgaABIAAgdIAaABIAyAAIAAgKIgCgSIAhAAIgBARIAAABIAAAKIAMAAIAWgBIAAAdIgWgBIgMAAIABBBIABAbg"
      );
    ...
    this.shape_29.graphics
      ...
      .s()
      .p(
        "AgxBCQgFgGgKgKQAqgOAYgZQAYgXAKgjIhSAAIgiABIAAgkQAKABAZABIBdAAQAJgBAGgCIASARQgDAEgCAIQgMAzgbAgQgbAggxAXQgGgLgEgHg"
      );
    ...
    this.shape_30.graphics
      ...
      .s()
      .p(
        "AAsBRQgggDgSgIQgjgRAAgmQAAgXARgVQAGgIANgJIgJABIgxAEIgcAEIgCglIAHAAIAjgBIBVgFIAUAAIAJgBIAJAAIAEgBIACAkIgFAAQgYAAgWAOQgPAKgJALQgHALAAANQAAARAQAHQAGAEALACQALABAKAAIAGAAIgFAmgAAcgUIAUgIQALAOAIAOIgTAJQgIgQgMgNgAA4gfIASgIQALAMAJAQIgTAJQgJgTgKgKg"
      );
    ...
    this.shape_31.graphics
      ...
      .s()
      .p(
        "AhGA+QAhgMAMgRQAIgKACgQIgnAAIggABIAAggQAKACAWAAIArAAIAAgRIAAgGQgSACgjACQgCgPgIgQIANABQAUAAAZgDQAYgDASgFQANgDAMgGIAWAdIgLADQgRAGgWAEIgBAbIAhAAQATAAANgCIAAAgIgggBIgjAAQgEAagJARQgLASgWAOQgHAFgMAFQgKgSgPgMg"
      );
    ...
    this.shape_32.graphics
      ...
      .s()
      .p(
        "AgqArQAegLARgQQARgQAKgYQAIgXAAgUIAhAIIgDAMQgIApgRAYQgQAXgaARIgXAOQgIgPgOgOgAhIg2IAdgIQAMAVAIAdIgfAKQgHgcgLgYgAgbg/IAbgIQANAaAHAXIgdAKQgGgYgMgbg"
      );
    ...
    this.shape_33.graphics
      ...
      .s()
      .p(
        "Ag9BAQArgPAYgaQgPgNgVgLIAVgZQAUALAQAMQAKgRAHgTIg3AAQgQAcgdAZQgNgOgQgIQAhgZARggQAHgOAEgOIAjAHIgIASIA1gBQAIAAAFgDIARASQgCADgCAFQgQAwgVAdQgUAagcATQgOAJgUAJQgKgQgOgOg"
      );
    ...
    this.shape_34.graphics
      ...
      .s()
      .p(
        "AgxA+QACgNAAgRIAAg9QAAgSgCgMIAoAAIAAAQQANgSAaAAQAJAAALACIgKAkQgMgEgIAAQgPAAgIALQgFAHgBAKIAAAfQAAARACANg"
      );
    ...
    this.shape_35.graphics
      ...
      .s()
      .p(
        "AgvAwQgSgSAAgeQAAgdASgSQARgSAeAAQAeAAASASQASASAAAdQAAAdgTASQgSATgdAAQgeAAgRgSgAgTgZQgIAJAAAQQAAAQAIAKQAHAJAMAAQANAAAHgJQAHgJAAgRQAAgQgHgJQgHgKgNAAQgMAAgHAKg"
      );
    ...
    this.shape_36.graphics
      ...
      .s()
      .p(
        "Ag6A+QApgPAZgZQAWgWALgiIg0AAQgSAegbAUQgNgPgQgIQAjgYATglQAGgOACgKIAlAHIgCAEIgCAEIgCAEIgEAJIAygBQAKAAAFgCIARAQQgDAFgDAJQgPAwgaAfQgbAdguAWQgJgRgPgOg"
      );
    ...
    this.shape_37.graphics
      ...
      .s()
      .p(
        "AgqArQAegLAQgQQASgQAJgYQAJgXAAgUIAhAIIgDAMQgJApgQAYQgQAXgaARIgXAOQgIgPgOgOgAhIg2IAegIQALAVAIAdIgfAKQgHgcgLgYgAgcg/IAdgIQANAaAGAXIgeAKQgFgYgNgbg"
      );
    ...
    this.shape_38.graphics
      ...
      .s()
      .p(
        "AgqA2QAZgFAOgIQAYgNAFgaQACgMAAgdIAAgUIgBgcIAnAAIgBAbIAAAYQAAAngFASQgJAfggAUQgQAIgZAIQgGgSgOgQgAhBAHIABgcIAAgnIgBgbIAnAAIgBAbIAAAnIABAcg"
      );
    ...
    this.shape_39.graphics
      ...
      .s()
      .p(
        "Ag6A+QApgPAZgZQAWgWALgiIg0AAQgSAegcAUQgMgPgQgIQAjgYASglQAIgOABgKIAlAHIgCAEIgCAEIgCAEIgEAJIAzgBQAIAAAGgCIARAQQgDAFgDAJQgPAwgaAfQgaAdgvAWQgJgRgPgOg"
      );
    ...
    this.shape_40.graphics
      ...
      .s()
      .p(
        ""
      );
    ...
    this.shape_41.graphics
      ...
      .s()
      .p(
        "AA4BcIAAgHIhvAAIAAAHIgeAAQABgNAAgRIAAhWIgBgbIAXABIAmAAIAFgMIgtAAIgcABIAAgeIAcABICBAAQAOAAAOgBIAAAeIgcgBIgyAAIgGAMIA3AAIAXgBIgBAbIAABXIABAdgAAqA5IAOAAIAAhRIgOAAgAgNA5IAbAAIAAgMIgbAAgAg3A5IAOAAIAAhRIgOAAgAgNAVIAbAAIAAgKIgbAAgAgNgNIAbAAIAAgLIgbAAg"
      );
    ...
    this.shape_42.graphics
      ...
      .s()
      .p(
        ""
      );
    ...
    this.damage_number_mc37.setTransform(
      687.1,
      249.1,
      1,
      1,
    ...
    this.damage_number_mc36.setTransform(
      687.1,
      229.1,
      1,
      1,
    ...
    this.damage_number_mc27.setTransform(
      627.1,
      249.1,
      1,
      1,
    ...
    this.damage_number_mc26.setTransform(
      627.1,
      229.1,
      1,
      1,
    ...
    this.damage_number_mc17.setTransform(
      567.1,
      249.1,
      1,
      1,
    ...
    this.damage_number_mc16.setTransform(
      567.1,
      229.1,
      1,
      1,
    ...
    this.damage_number_mcb5.setTransform(
      388.1,
      -19.3,
      1,
      1,
    ...
    this.damage_number_mcb4.setTransform(
      304.1,
      -19.7,
      1,
      1,
    ...
    this.damage_number_mcb3.setTransform(
      219.9,
      -19.6,
      1,
      1,
    ...
    this.damage_number_mcb2.setTransform(
      132.8,
      -19.5,
      1,
      1,
    ...
    this.damage_number_mc35.setTransform(
      687.1,
      209.1,
      1,
      1,
    ...
    this.damage_number_mc34.setTransform(
      687.1,
      189.1,
      1,
      1,
    ...
    this.damage_number_mc33.setTransform(
      687.1,
      169.1,
      1,
      1,
    ...
    this.damage_number_mc32.setTransform(
      687.1,
      149.1,
      1,
      1,
    ...
    this.damage_number_mc31.setTransform(
      687.1,
      129.1,
      1,
      1,
    ...
    this.damage_number_mc25.setTransform(
      627.1,
      209.1,
      1,
      1,
    ...
    this.damage_number_mc24.setTransform(
      627.1,
      189.1,
      1,
      1,
    ...
    this.damage_number_mc23.setTransform(
      627.1,
      169.1,
      1,
      1,
    ...
    this.damage_number_mc22.setTransform(
      627.1,
      149.1,
      1,
      1,
    ...
    this.damage_number_mc21.setTransform(
      627.1,
      129.1,
      1,
      1,
    ...
    this.damage_number_mc15.setTransform(
      567.1,
      209.1,
      1,
      1,
    ...
    this.damage_number_mc14.setTransform(
      567.1,
      189.1,
      1,
      1,
    ...
    this.damage_number_mc13.setTransform(
      567.1,
      169.1,
      1,
      1,
    ...
    this.damage_number_mc12.setTransform(
      567.1,
      149.1,
      1,
      1,
    ...
    this.damage_number_mc11.setTransform(
      567.1,
      129.1,
      1,
      1,
    ...
    this.hp_number_mc5.setTransform(
      438.5,
      22.6,
      0.51,
      0.51,
    ...
    this.hp_number_mc4.setTransform(
      352.8,
      22.7,
      0.51,
      0.51,
    ...
    this.hp_number_mc3.setTransform(
      269.1,
      22.6,
      0.51,
      0.51,
    ...
    this.hp_number_mc2.setTransform(
      184.3,
      22.6,
      0.51,
      0.51,
    ...
    this.hp_number_mc1.setTransform(
      100.3,
      22.7,
      0.51,
      0.51,
        ...
        .to(
          {
            state: [
              ...
              { t: this.instance_1 },
              { t: this.instance },
              { t: this.hp_number_mc1 },
              { t: this.hp_number_mc2 },
              { t: this.hp_number_mc3 },
              { t: this.hp_number_mc4 },
              { t: this.hp_number_mc5 },
              { t: this.hp_bar_mc1 },
              { t: this.hp_bar_mc2 },
              { t: this.hp_bar_mc3 },
              { t: this.hp_bar_mc4 },
              { t: this.hp_bar_mc5 },
              { t: this.damage_number_mc11 },
              { t: this.damage_number_mc12 },
              { t: this.damage_number_mc13 },
              { t: this.damage_number_mc14 },
              { t: this.damage_number_mc15 },
              { t: this.damage_number_mc21 },
              { t: this.damage_number_mc22 },
              { t: this.damage_number_mc23 },
              { t: this.damage_number_mc24 },
              { t: this.damage_number_mc25 },
              { t: this.damage_number_mc31 },
              { t: this.damage_number_mc32 },
              { t: this.damage_number_mc33 },
              { t: this.damage_number_mc34 },
              { t: this.damage_number_mc35 },
              { t: this.number_mc2 },
              { t: this.damage_number_mcb1 },
              { t: this.damage_number_mcb2 },
              { t: this.damage_number_mcb3 },
              { t: this.damage_number_mcb4 },
              { t: this.damage_number_mcb5 },
              { t: this.damage_number_mc16 },
              { t: this.damage_number_mc17 },
              { t: this.damage_number_mc26 },
              { t: this.damage_number_mc27 },
              { t: this.damage_number_mc36 },
              { t: this.damage_number_mc37 },
            ],
          },
          2
        )
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.logo_mc).to({ _off: true }, 2).wait(1)
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.bom_effect_mc).wait(2).to({ _off: false }, 0).wait(1)
    );
    ...
    this.shape_43.graphics
      ...
      .s()
      .p("EglfAyxMAAAhlhMBK/AAAMAAABlhg");
    this.shape_43.setTransform(240, 324.9);

    this.timeline.addTween(
      cjs.Tween.get(this.shape_43).to({ _off: true }, 2).wait(1)
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get({})
        .to({ state: [] })
        .to({ state: [{ t: this.effect_star_mc }, { t: this.instance_6 }] }, 2)
        .wait(1)
    );
    ...
    this.timeline.addTween(
      cjs.Tween.get(this.instance_14).wait(2).to({ _off: false }, 0).wait(1)
    );
  ...
  lib.properties = {
    ...
    manifest: [
      ...
      { src: "images/pants.png", id: "pants" },
      { src: "images/bra.png", id: "bra" },
      { src: "images/clothes.png", id: "clothes" },
      { src: "images/underclothes.png", id: "underclothes" },
      { src: "images/sweat.png", id: "sweat" },
      { src: "images/point.png", id: "point" },
      { src: "images/reimu0.png", id: "reimu0" },
      { src: "images/reimu1.png", id: "reimu1" },
      { src: "images/reimu2.png", id: "reimu2" },
      { src: "images/reimu3.png", id: "reimu3" },
      { src: "images/reimu4.png", id: "reimu4" },
      { src: "images/reimu5.png", id: "reimu5" },
      { src: "images/reimuclimax.png", id: "reimuclimax" },
    ],
    preloads: [],
  };
